...
DataSet File::createDataSet(const std::string & dataset_name, const DataSpace & space, const DataType & dtype){
    DataSet set;
    hid_t hid_ds;
...
DataSet File::createDataSet(const std::string & dataset_name, const DataSpace & space){
