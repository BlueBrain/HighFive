...
BOOST_AUTO_TEST_CASE(H5Easy_extend1d)
{
    ...
    xt::xarray<std::size_t> A_r = HighFive::load<xt::xarray<std::size_t>>(file, "/path/to/A");

    std::size_t Amax = HighFive::load<std::size_t>(file, "/path/to/A", {9});
...
BOOST_AUTO_TEST_CASE(H5Easy_extend2d)
{
    ...
    std::size_t Amax = HighFive::load<std::size_t>(file, "/path/to/A", {9,4});
